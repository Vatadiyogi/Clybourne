    ...
    try {
        ...
        try {
            const valuationDataResponse = await axios.get(
                `${process.env.APIURL || 'http://localhost:5050'}api/admin/orders/valuation-data/${orderId}`,
                { timeout: 10000 }
            );
        ...
        const dcfTableData = {
            ...
            equityValueMin: companyEquityMinValue,
            equityValueMax: companyEquityMaxValue,
